...
public class LoginPage {
    ...
    public void login(String username, String password, String url) {
        try {
            // Use provided URL or get from driver's current URL
            if (url == null || url.isEmpty()) {
                // If no URL provided, assume driver already navigated to correct page
                // (BaseTest already navigates in setup)
            } else {
                driver.get(url);
            }
